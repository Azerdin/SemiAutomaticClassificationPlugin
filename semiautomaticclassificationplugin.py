    ...
    def __init__(self, iface):
        ...
        if plugin_check:
            ...
            from .interface import (
                ...
                remove_outliers_dialog, remove_outliers, remove_outliers_use_case
            )
...
def connect_gui():
    ...
    if cfg.simplified:
        ...
        remove_outliers_b = cfg.dock_class_simpl_dlg.ui.remove_outliers_Button
        remove_outliers_b.clicked.connect(
