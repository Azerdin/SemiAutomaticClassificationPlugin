...
DATA = os.environ.get("PODBADANIA_DIR", RESULTS_ROOT + "/podbadania_v2")
OUT = os.environ.get("AGREGACJA_DIR", RESULTS_ROOT + "/agregacja_v2")
...
if __name__ == "__main__":
    os.makedirs(OUT, exist_ok=True)
    gen_gridsearch()
    gen_pipelines("poprawny", "podbadania_potoki_poprawny.csv")
    gen_pipelines("zbledami", "podbadania_potoki_zbledami.csv")
    gen_rf()
