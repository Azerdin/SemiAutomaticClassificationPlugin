...
RASTERS = {
    "L1C": DATA_DIR + "/L1C/L1C_przyciety.tif",
    "L2A": DATA_DIR + "/L2A/L2A_przyciety.tif",
}

_ROI = DATA_DIR + "/ROI/warianty"
_ROIB = DATA_DIR + "/ROI_blad/warianty"
_REF = DATA_DIR + "/referencja2/warianty"
VARIANTS = {
    v: {
...
OUTPUT_DIR = RESULTS_ROOT + "/benchmark_results_v2"
N_PROCESSES = 8
RAM_MB = 36000
WORKERS = 1
...
_METHOD_DESCRIPTIONS = {
    ...
    "Percentile": ("progowa", "Przycięcie percentylowe — usuwa piksele poza "
                   "zadanym zakresem percentyli w którymkolwiek paśmie; łączny "
                   "udział odrzuconych zależy od liczby pasm i korelacji między nimi."),
