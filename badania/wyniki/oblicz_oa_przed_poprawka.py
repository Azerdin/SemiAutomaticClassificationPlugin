...
REF = DATA_DIR + "/referencja2/warianty/referencja_1456.shp"
CLASS_FIELD = "klasa"
BEFORE_DIR = RESULTS_ROOT + "/klasyfikacja przed poprawka"

AFTER_SVM = (RESULTS_ROOT + "/benchmark_results_v2/1456_poprawny_L1C_class/"
