# -*- coding: utf-8 -*-
"""Wytwarza osiem wariantów zestawu klas z pełnej warstwy referencyjnej.

WEJŚCIE:      dane_testowe/referencja2/referencja_FINAL.shp
WYJŚCIE:      dane_testowe/referencja2/warianty/referencja_<wariant>.shp
URUCHOMIENIE: python3 badania/dane/generuj_warianty_referencja.py   (wymaga GDAL/OGR)
"""
...
SRC = DATA_DIR + "/referencja2/referencja_FINAL.shp"
OUT_DIR = DATA_DIR + "/referencja2/warianty"
PREFIX = "referencja_"
SUFFIX = ""
CLASS_FIELD = "moja_ocena"
COPY_FIELDS = ["moja_ocena"]
...
def main():
    parser = argparse.ArgumentParser(
        description="Generuje 8 wariantów zestawu klas z warstwy referencyjnej.")
    parser.add_argument(
    ...
    if args.dry_run:
        ...
        print("REFERENCJA: źródło %s -> %s | pole klasy: %s | %s"
              % (SRC, OUT_DIR, CLASS_FIELD, "OK" if ok else "BRAK PLIKU"))
        print("\n--dry-run: nic nie zapisano.")
        return

    print("=== REFERENCJA: %s -> %s ===" % (os.path.basename(SRC), OUT_DIR))
